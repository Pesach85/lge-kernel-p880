...
#define CPU_MILLIVOLTS {\
	750, 775, 800, 825, 850, 875, 900, 916, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1225, 1237, 1275};
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):         750, 775, 800, 825, 850, 875, 900, 916, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1225, 1237, 1275 */
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ, 460, 460, 550, 550,  680,  680,  680,  820, 820,  970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1360, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 480, 480, 650, 650,  780,  780,  780,  850, 990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700),
...
static struct dvfs cpu_0_dvfs_table[] = {
        ...
        CPU_DVFS("cpu_0",  4, 0, MHZ, 460, 460, 550, 550,  680,  680,  680,  820, 820, 900, 970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1360, 1500, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 1, MHZ, 480, 480, 650, 650,  780,  780,  780, 870, 990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 2, MHZ, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600, 1700),
	CPU_DVFS("cpu_0",  4, 3, MHZ, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700),
...
static struct dvfs core_dvfs_table[] = {
	/* Core voltages (mV):		    900,    950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  416000,  416000,  466000,  466000),
