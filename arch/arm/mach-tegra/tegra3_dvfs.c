...
#define CPU_MILLIVOLTS {\
	750, 775, 800, 825, 850, 875, 887, 900, 925, 950, 975, 1000, 1012, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1225};
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):         750, 775, 825, 850, 875, 900, 916, 950, 975, 1000, 1007, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1212, 1225, 1237 */

	CPU_DVFS("cpu_g",  0, 0, MHZ,   1,  1,  1,  1, 684, 684,  817,  817,  817, 1026, 1102, 1102, 1149, 1187, 1225, 1282, 1300),
	CPU_DVFS("cpu_g",  0, 1, MHZ,   1,  1,  1,  1, 807, 807,  948,  948,  948, 1117, 1171, 1171, 1206, 1300),
	CPU_DVFS("cpu_g",  0, 2, MHZ,   1,  1,  1,  1, 883, 883, 1039, 1039, 1039, 1178, 1206, 1206, 1300),
	CPU_DVFS("cpu_g",  0, 3, MHZ,   1,  1,  1,  1, 931, 931, 1102, 1102, 1102, 1216, 1300, 1300),

	CPU_DVFS("cpu_g",  1, 0, MHZ, 1, 1, 1, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1280, 1300),
	CPU_DVFS("cpu_g",  1, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1300),
	CPU_DVFS("cpu_g",  1, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1300),
	CPU_DVFS("cpu_g",  1, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1300),

	CPU_DVFS("cpu_g",  2, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1400),
	CPU_DVFS("cpu_g",  2, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1350, 1400),
	CPU_DVFS("cpu_g",  2, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1300, 1350, 1400),

	CPU_DVFS("cpu_g",  3, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1400),
	CPU_DVFS("cpu_g",  3, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1350, 1400),
	CPU_DVFS("cpu_g",  3, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1300, 1350, 1400),

	CPU_DVFS("cpu_g",  4, 0, MHZ, 1, 1, 1, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1360, 1500, 1600),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1500, 1600),

	CPU_DVFS("cpu_g",  5, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_g",  5, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),

	CPU_DVFS("cpu_g",  6, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_g",  6, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),

	CPU_DVFS("cpu_g",  7, 0, MHZ, 1, 1, 1, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1280, 1300),
	CPU_DVFS("cpu_g",  7, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1300),
	CPU_DVFS("cpu_g",  7, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1300),
	CPU_DVFS("cpu_g",  7, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1300),
	CPU_DVFS("cpu_g",  7, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1300, 1300),

	CPU_DVFS("cpu_g",  8, 0, MHZ, 1, 1, 1, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1280, 1300),
	CPU_DVFS("cpu_g",  8, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1300),
	CPU_DVFS("cpu_g",  8, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1300),
	CPU_DVFS("cpu_g",  8, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1300),
	CPU_DVFS("cpu_g",  8, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1300, 1300),
	...
	CPU_DVFS("cpu_g", 12, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_g", 12, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),

	CPU_DVFS("cpu_g", 13, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_g", 13, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),
	 ...
	 */
	CPU_DVFS("cpu_0", -1, -1, MHZ, 1,   1, 216, 216, 300),

};

static struct dvfs cpu_0_dvfs_table[] = {
 
        CPU_DVFS("cpu_0",  4, 0, MHZ, 1, 1, 1, 460, 460, 550, 550,  680,  680,  680,  820,  970,  970, 1040, 1080, 1150, 1200, 1240, 1280, 1320, 1360, 1360, 1500, 1600),
	CPU_DVFS("cpu_0",  4, 1, MHZ, 1, 1, 1, 480, 480, 650, 650,  780,  780,  780,  990, 1040, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600),
	CPU_DVFS("cpu_0",  4, 2, MHZ, 1, 1, 1, 520, 520, 700, 700,  860,  860,  860, 1050, 1150, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600),
	CPU_DVFS("cpu_0",  4, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1500, 1600),

	CPU_DVFS("cpu_0",  5, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_0",  5, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),

	CPU_DVFS("cpu_0",  6, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_0",  6, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),

        CPU_DVFS("cpu_0", 12, 3, MHZ, 1, 1, 1, 550, 550, 770, 770,  910,  910,  910, 1150, 1230, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1540, 1700),
	CPU_DVFS("cpu_0", 12, 4, MHZ, 1, 1, 1, 550, 550, 770, 770,  940,  940,  940, 1160, 1240, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1590, 1700),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 0, 1, KHZ,        1, 294000, 342000, 427000, 475000,  500000,  500000,  566000,  566000),
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   102000, 294000, 342000, 427000, 475000,  500000,  500000,  566000,  566000),
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),

#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  533000,  533000),
#else
	CORE_DVFS("vde",    1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 234000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 285000, 332000, 380000,  416000,  466000,  533000,  533000),
#endif
	...
	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  484000,  533000,  533000),
	...
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
